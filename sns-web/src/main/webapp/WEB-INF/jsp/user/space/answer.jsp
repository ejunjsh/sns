...
<div class="grow gmt60 answer-page">
 <%@ include file="/WEB-INF/jsp/user/space/common/leftSize.jsp"%>
            ...
            <div class="gbtitle">
        <h2><a href="<%=request.getContextPath()%>/i/<s:property value="spaceUser.id" />/" class="gbtitle-link">个人主页</a><span class="entities">&gt;</span>回答<span class="gbtitle-more">（全部<s:property value="spaceUser.answerCount" />个）</span></h2>
    </div>
    <ul class="answer_list">
    <s:iterator value="myAnswers">
    <li class="answer gclear">
            <h2><a href="<%=request.getContextPath()%>/question/<s:property value="questionId" />/" target="_blank"><s:property value="question.title" /></a></h2>
            <p><s:property value="contentNoHtml100" escape="false"/><a href="<%=request.getContextPath()%>/answer/<s:property value="id" />/redirect/" target="_blank">查看全文</a></p>
