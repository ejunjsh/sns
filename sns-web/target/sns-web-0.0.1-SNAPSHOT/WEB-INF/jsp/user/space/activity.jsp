...
<div class="grow gmt60 activity-page">
 <%@ include file="/WEB-INF/jsp/user/space/common/leftSize.jsp"%>
            ...
            <div class="gbtitle">
        <h2><a href="<%=request.getContextPath()%>/i/<s:property value="spaceUser.id" />/" class="gbtitle-link">个人主页</a><span class="entities">&gt;</span>动态<span class="gbtitle-more">（全部<s:property value="spaceUser.activityCount" />个）</span></h2>
    </div>
