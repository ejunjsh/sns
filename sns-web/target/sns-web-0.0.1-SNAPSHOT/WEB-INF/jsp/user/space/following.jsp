...
<body>
	<div class="container">
<div class="grow gmt60 following-page">
 <%@ include file="/WEB-INF/jsp/user/space/common/leftSize.jsp"%>
            <div class="main gprefix-1 gspan-25">
            <div class="gbtitle">
        <h2><a href="<%=request.getContextPath()%>/i/<s:property value="spaceUser.id" />/" class="gbtitle-link">个人主页</a><span class="entities">&gt;</span>关注<span class="gbtitle-more">（全部<s:property value="spaceUser.followingCount" />人）</span></h2>
    </div>
    <ul class="gfollow-list">
    <s:iterator value="followingUsers">
    <li>
...
<a href="<s:property value="blogUrl" />"><s:property value="blogUrl" /></a>
    ...
    <p:pages pageSize="${pageSize}" pageNo="${pageNo}" recordCount="${spaceUser.followingCount}"></p:pages>
            </div>
