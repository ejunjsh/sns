...
<link type="text/css"
	href="<%=request.getContextPath()%>/staticFile/css/tag.css"
	rel="stylesheet" />
</head>
<body>
<div class="container">
...
<li>
    ...
    <p:pages pageSize="${pageSize}" pageNo="${pageNo}" recordCount="${spaceUser.tagCount}"></p:pages>
        ...
        <div class="side gspan-10 gprefix-1 gmt60">
            <form action="<%=request.getContextPath()%>/tag/all/" class="gsearch" method="get">
                <p>
            ...
            <s:if test="key!=null&&key!=''">
            <p><a href="<%=request.getContextPath()%>/tag/all/">返回标签广场&nbsp;&gt;</a></p>
            </s:if>
        </div>
    </div>
