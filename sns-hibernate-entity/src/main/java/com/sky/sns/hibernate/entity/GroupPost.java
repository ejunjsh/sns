...
public class GroupPost {
	...
	@JoinTable(name = "GroupPost_User_Recommend", joinColumns = { @JoinColumn(name = "groupPostId")},inverseJoinColumns={@JoinColumn(name="userId") })
    private List<User> recommendUsers;

	@ManyToMany(cascade = CascadeType.ALL)  
	 @JoinTable(name = "GroupPost_Tag", joinColumns = { @JoinColumn(name = "groupPostId")},inverseJoinColumns={@JoinColumn(name="tagId") })
	...
	public void setBlogCategory(Group group) {
		this.group = group;
	}
